...
class GHLTenantMapping(Base):
    ...
    token_expires_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True, index=True)
    scopes: Mapped[list[str]] = mapped_column(JSON, default=list, nullable=False)
    token_source: Mapped[str] = mapped_column(String(40), default="manual", nullable=False)
