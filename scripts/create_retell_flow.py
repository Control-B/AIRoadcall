...
FLOW = {
    ...
    "global_prompt": "\n".join([
        ...
        "WEBSITE-FIRST LOCATION: Prefer the public_code from create_dispatch_session. The code is a simple two-word phrase. Say exactly: 'I’m opening your Roadcall location page now. Please go to roadcall.ai slash go and enter the two words [public_code], then tap Submit and share GPS. Stay on the line with me.' Read the two words slowly.",
        ...
        # ── 2. Search intake without repeating greeting ──
        {
            ...
            "instruction": {
                ...
                "text": (
                    ...
                    "As soon as caller_name and problem/help needed are known, call create_dispatch_session if it has not already been called. Pass caller_phone from call metadata when available plus every known ledger fact. Store dispatch_session_id, public_code, and location_url. Then say exactly: 'I’m opening your Roadcall location page now. Please go to roadcall.ai slash go and enter the two words [public_code], then tap Submit and share GPS. Stay on the line with me.'\n"
