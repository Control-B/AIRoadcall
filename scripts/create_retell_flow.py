    ...
    "tools": [
        {
            ...
            "description": "Create or reuse the durable Roadcall dispatch session for this live Retell call. Always pass caller_phone from Retell call metadata so the backend can attach GPS already shared from the Roadcall map phone button. Use dispatch_session_id for backend polling. Do not speak any returned location code, URL, or link to the caller.",
