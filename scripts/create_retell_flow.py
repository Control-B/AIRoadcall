...
FLOW = {
    ...
    "global_prompt": "\n".join([
        ...
        "WEBSITE LOCATION FIRST: As soon as caller_name and problem/help needed are known, call create_dispatch_session and tell the caller to open roadcall.ai/go and enter the two-word public_code. Do not wait for mechanic results before starting the website location flow.",
        ...
        "WEBSITE-FIRST LOCATION: Prefer the public_code from create_dispatch_session. The code is a simple two-word phrase. After create_dispatch_session returns, speak the actual returned public_code value word-for-word. Say: 'I’m opening your Roadcall location page now. Please go to roadcall.ai slash go and enter this two-word code: ' followed by the exact public_code, then say: 'then tap Submit and share GPS. Stay on the line with me.' Read the two words slowly. Never say '[public_code]' or 'the two words I gave you.' If public_code is missing, do not send the caller to the website yet; call create_dispatch_session again or say you are still generating the code.",
        ...
        # ── 2. Search intake without repeating greeting ──
        {
            ...
            "instruction": {
                ...
                "text": (
                    ...
                    "As soon as caller_name and problem/help needed are known, call create_dispatch_session if it has not already been called. Pass caller_phone from call metadata when available plus every known ledger fact. Store dispatch_session_id, public_code, and location_url. Then speak the actual returned public_code value. Say: 'I’m opening your Roadcall location page now. Please go to roadcall.ai slash go and enter this two-word code: ' followed by the exact public_code, then say: 'then tap Submit and share GPS. Stay on the line with me.' Never say '[public_code]' or 'the two words I gave you.'\n"
        ...
        # ── 5. Location Request ───────────────────────────
        {
            ...
            "instruction": {
                ...
                "text": (
                    ...
                    "Tell the driver: 'Please open roadcall.ai/go in your browser and enter this two-word code: ' followed by the exact public_code, then say: 'then tap Share My Location. Stay on the line with me.' Never say '[public_code]' or 'the two words I gave you.'\n"
