...
GLOBAL_PROMPT = "\n".join([
    ...
    "HARD RULE — KEEP IT SHORT: ask one question at a time. Get name first, use caller_phone from Retell call metadata when available, then intent, then the few details you need for that intent. Do not ask for phone if the call already provides caller_phone.",
    ...
    "When the caller describes a mechanical symptom, call intake_guide with the complaint. Use the returned targeted questions and ticket_fields to capture a structured service ticket without over-questioning.",
...
TOOLS = [
    {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "requested_handoff": {"type": "boolean"},
                "notes": {"type": "string"},
            },
    ...
    {
        "type": "custom",
        "tool_id": "tool-shopai-intake-guide",
        "name": "intake_guide",
        "description": "Return symptom-specific service-advisor questions, structured ticket fields, and emergency flags. Call when a caller describes a mechanical issue.",
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "caller_type": {"type": "string", "enum": ["shop", "fleet"], "description": "Always shop"},
            },
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "triage": {
                    ...
                    "properties": {
                        "symptom_category": {"type": "string"},
                        "classification": {"type": "string", "description": "safe_to_drive|can_limp_to_shop|mobile_repair_candidate|tow_required|scheduled_service|critical_out_of_service"},
                        "safe_to_drive": {"type": "boolean"},
                        "emergency_flags": {"type": "array", "items": {"type": "string"}},
                        "handoff_required": {"type": "boolean"},
                        "handoff_reason": {"type": "string"},
                ...
                "post_call_automation": {
                    "type": "object",
                    "properties": {
                        "send_booking_confirmation": {"type": "boolean"},
                        "send_directions": {"type": "boolean"},
                        "send_review_request": {"type": "boolean"},
