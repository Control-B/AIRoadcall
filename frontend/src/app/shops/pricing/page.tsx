...
const PLANS = [
  {
    ...
    price: "$99.99",
    setup: "$49.99 setup",
    target: "For mechanics that do not want a new website but need an AI widget for intake, FAQs, and lead capture.",
    icon: MessageSquare,
    accent: "from-sky-400 to-blue-500",
    cta: "Start Widget Only",
    href: "/mechanic/checkout?plan=widget_only",
    category: "Simple Roadcall Plan",
    features: [
      "AI widget only",
      "FAQ assistant",
      "Appointment capture",
  ...
  },
  {
    ...
    price: "$99.99",
    setup: "$49.99 setup",
    target: "AI answering and intake for mechanics that want phone automation without website or widget setup.",
    icon: Headphones,
  ...
  },
  {
    ...
    price: "$149.99",
    setup: "$97.99 setup",
    target: "The combined widget and AI phone package for shops that want web and voice intake without GHL.",
    icon: Bot,
  ...
  },
  {
    ...
    price: "$19.99",
    setup: "No setup fee",
    target: "For trucking companies that need map view access and additional provider information.",
    icon: Truck,
    accent: "from-blue-300 to-orange-300",
    cta: "Start Enterprise",
    href: "/mechanic/checkout?plan=enterprise",
    category: "Simple Trucking Plan",
    features: [
      "Map view access",
      "Additional provider information",
      "Trucking company profile",
  ...
  },
  {
    ...
    price: "$297",
    setup: "$149 setup",
    target: "GHL plan with website, AI telephone, widget, CRM, workflows, and snapshot provisioning.",
    icon: Globe2,
    accent: "from-blue-400 to-cyan-300",
    cta: "Start Standard in GHL",
  ...
  },
  {
    ...
    price: "$497",
    setup: "$199 setup",
    target: "Everything in Standard plus mobile app access for the full GHL-powered business OS.",
    icon: BarChart3,
    accent: "from-roadcall-orange via-amber-400 to-blue-400",
    cta: "Start Professional in GHL",
    href: GHL_GET_STARTED_URL,
    category: "GHL SaaS Plan",
    features: [
  ...
  },
  {
    ...
    price: "$997",
    setup: "$299 setup",
    target: "Everything in Professional plus social media marketing inside the GHL-powered business OS.",
    icon: Network,
    accent: "from-blue-400 to-cyan-300",
    cta: "Start Advanced in GHL",
    href: GHL_GET_STARTED_URL,
    category: "GHL SaaS Plan",
    features: [
    ...
    <main className="min-h-screen overflow-hidden bg-[#02050c] text-white selection:bg-roadcall-orange/30 selection:text-white">
      ...
      <section id="pricing" className="relative z-10 px-4 py-16 sm:px-6 lg:py-24">
        <motion.div {...fadeUp()} className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="mt-4 text-4xl font-black tracking-[-0.04em] sm:text-5xl">Simple Roadcall plans plus GHL-powered growth plans.</h2>
          <p className="mt-5 text-roadcall-muted">Use Stripe checkout for widget, AI telephony, and trucking map access. Use GHL for Standard, Professional, and Advanced.</p>
        </motion.div>
